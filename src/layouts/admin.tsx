                            ...
                            <Menu position="right-end" offset={10} width={160}>
                                <Menu.Target>
                                    <Menu.Item
                                        ...
                                        leftSection={
                                            <LanguagesIcon className="size-4 stroke-gray-600" />
                                        }
                                        rightSection={
                                            <ChevronRightIcon className="size-4 stroke-gray-600" />
                                        }
                                    >
                                        <div className="flex items-center justify-between">
                                            <span>
                                                <FormattedMessage id="layouts.admin.menu.language" />
                                            </span>
                            ...
                            >
                                <Menu.Target>
                                    <Menu.Item
                                        closeMenuOnClick={false}
                                        leftSection={
                                            <SunMoonIcon className="size-4 stroke-gray-600" />
                                        }
                                        rightSection={
                                            <ChevronRightIcon className="size-4 stroke-gray-600" />
                                        }
