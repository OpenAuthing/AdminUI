import { UnstyledButton, Popover, Text, Button } from "@mantine/core"
    ...
    return (
        <div className="w-full">
            {DateRangeOptions.map((option) => {
                ...
                return (
                    <UnstyledButton key={option.type}
                ...
                <div>
                    <div className="grid grid-cols-[175px_minmax(0px,2fr)] gap-x-8">
                        ...
                        <div className="pt-2 pb-4 px-4 grid grid-cols-1 gap-y-6">
                            <DatePicker withCellSpacing={false} type="range" size="md" maxLevel="month" onChange={handleDateRangeChanged}/>
                        </div>
                    </div>
